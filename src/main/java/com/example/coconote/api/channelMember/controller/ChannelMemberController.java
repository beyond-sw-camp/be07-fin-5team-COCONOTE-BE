...
public class ChannelMemberController {
    ...
    @PostMapping("/channelMember/create") // 채널 가입
    public ResponseEntity<Object> channelMemberCreate(@RequestBody ChannelMemberCreateReqDto dto) {
        ChannelMember channelMember = channelMemberService.channelMemberCreate(dto);
    ...
    @GetMapping("/channelMember/list") // 채널 유저 목록 조회
    public ResponseEntity<Object> channelMemberRead() {
        List<ChanneMemberlListResDto> dtos = channelMemberService.channelMemberList();
    ...
    @PatchMapping("/channelMember/bookmark/{id}") // 채널 관리자
    public ResponseEntity<Object> channelUpdate(@PathVariable Long id, @RequestBody ChannelUpdateReqDto dto) {
        channelMemberService.channelMemberUpdate(id, dto);
        CommonResDto commonResDto = new CommonResDto(HttpStatus.OK, "channelMember is successfully updated", null);
        return new ResponseEntity<>(commonResDto, HttpStatus.OK);
